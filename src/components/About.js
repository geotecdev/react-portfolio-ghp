...
import dotNetMenuPic from "../images/asp-dot-net-img.PNG";
import wpfMenuPic from "../images/wpf-img.PNG";
import officeMenuPic from "../images/office-img.png";
import azureMenuPic from "../images/azure-img.PNG";
import matplotlibMenuPic from "../images/matplotlib-img.PNG";
                    ...
                    <nav className="row sectionContainer">
                        ...
                        <section className="tab-content">
                            <figure id="app1" className="tab-pane fade in active">
                                <img className="appThumbnail" src={dotNetMenuPic} alt="split screen thumbnail with the landing page for Menard's web api, in front of a C# code file of a Controller class"/>                    
                            ...
                            <figure id="app2" className="tab-pane fade">
                                <img className="appThumbnail" src={wpfMenuPic} alt="screenshot from the xaml layout page in Visual Studio for a userform from the payroll processing application" />
                            ...
                            <figure id="app3" className="tab-pane fade">
                                <img className="appThumbnail" src={officeMenuPic} alt="thumbnail with an image from the excel vba editor, including an overlayed userform "/>
                            ...
                            <figure id="app4" className="tab-pane fade">
                                <img className="appThumbnail" src={azureMenuPic} alt="screenshot of Menard's resources page from the Azure portal" />
                            ...
                            <figure id="app5" className="tab-pane fade">
                                <img className="appThumbnail" src={matplotlibMenuPic} alt="split screen of a Matplotlib PowerBI chart visual and the python codebehind" />
